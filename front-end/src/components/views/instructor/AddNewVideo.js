...
function AddNewVideo({ courseId }) {
	...
	return (
		<React.Fragment>
			<Button sx={{ fontSize: "1.1rem", margin: 2 }} onClick={handleOpen}>
				Add New Videos to this course
			</Button>
			<Modal
				open={open}
				onClose={handleClose}
